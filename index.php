...
$inch = json_decode(file_get_contents("https://api.telegram.org/bot".API_KEY."/getChatMember?chat_id=@cc1&user_id=$from_id"))->result->status;
$inch2 = json_decode(file_get_contents("https://api.telegram.org/bot".API_KEY."/getChatMember?chat_id=@dd1&user_id=$from_id"))->result->status;
...
- Soltan Bot team !",
            'reply_markup' => json_encode([
                'inline_keyboard' => [
                    [
                        ['text' => "دیدن تبلیغات درون کانال و دریافت بازدید", 'url' => "https://t.me/dd1/354"]
                    ]
                ]
            ])
        ]);
    ...
    unlink("cod/$chatid.txt");
        ...
        bot('sendmessage', [
            'chat_id' => $chat_id,
            'text' => "روزانه ده ها نفر با استفاده از ایده ی جدید و کاربردی ربات نیک ویو در امر ویو یا همان بازدید زدن ، بازدید پست ها بنر ها چالش ها و چیزی که مد نظرشان هست را بالا میبرندروزانه ده ها نفر با استفاده از ایده ی جدید و کاربردی ربات نیک ویو در امر ویو یا همان بازدید زدن ، بازدید پست ها بنر ها چالش ها و چیزی که مد نظرشان هست را بالا میبرندروزانه ده ها نفر با استفاده از ایده ی جدید و کاربردی ربات نیک ویو در امر ویو (همان بازدید زدن ) ، بازدید پست ها ، بنر ها ، چالش ها و چیزی که مد نظرشان هست را بالا میبرند !
...
موفق باشید🤷‍♂️",
        ...
        'photo'=>"https://soltan.torbohost.ir/p/1.png",
        'caption'=>"ًنیک ویو ، یک ایده جدید ! 👁‍🗨
...
توصیه ما اینه که ثبت تبلیغ هاتون ثبت بازدید هاتون و کلا فعالیت هاتون رو بزاری بین ساعات 7 شب تا 12 شب که همه آنلاین هستند ویو عالی میشه !

و از ساعت 1 شب تا 10 صبح سعی کنید اصلا تبلیغ ثبت نکنید چون خوب معلومه همه خواب هستند ویو خیلی پایینه بعدشم پست میزارید دونفر که خواب هستند هم عصبانی میشن لفت میدن 😐
...
🔎 کد رهگیری سفارش شما $msg_id می باشد و میتوانی از بخش پیگیری سفارش ، آمار مربوطه را مشاهده نمایید.",
           'reply_markup' => json_encode([
                'inline_keyboard' => [
                    [
            ['text' => "مشاهده تبلیغ در کانال", 'url' => "https://t.me/dd1/$msg_id"]
                    ],
                ]
            ])
        ]);
...
[['text'=>"لینک مستقیم درخواست بازدید 👇🏻",'url'=>"https://t.me/dd1/$message_id12"]],
]
])
 ]);
}
