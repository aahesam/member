...
//متغیر ها :
// msg
$Dev = array("698038310","698038310","698030310"); //
...
❇️لطفا از طریق ربات پیام رسان پیام خود را ارسال کنید تا رسیدگی بشه ",
...
$coin = $cuser["userfild"]["$fromid"]["coin"];
		bot('sendphoto',[
	'chat_id'=>$chatid,
	'photo'=>new CURLFile("other/logo.png"),
...
https://t.me/$usernamebot?start=$fromid",
	...
	bot('sendmessage',[
	'chat_id'=>$chatid,
	'text'=>"📍 بنر بالا حاوی لینک دعوت اختصاصی شما برای وروده به ربات ممبرگیر است با اشتراک بنر برای گروه ها و دوستانتان سکه جمع کنید
...
3️⃣ ربات ممبرگیر هیچ مسولیتی در قبال تکمیل سفارش شما ندارد ممکن است تعداد از عضو ها بعد از عضو شدن از کانال لفت بدهند
...
elseif($data=="about"){
     ...
     'message_id'=>$messageid,
               'text'=>"ℹ️ درباره ربات :
🎉 ربات ممبرگیر راهی برای پیش رفت شما 
",
               'reply_markup'=>json_encode([
                   'inline_keyboard'=>[
				   				   [
