...
[[['text'=>"به کانال ما بپیوندید",'url'=>"https://telegram.me/Khabar_arz"]]]
                            ])
]                )
        );
}
...
elseif ($textmessage == '/Creator')
{
SendMessage($chat_id,"این ربات توسط `@Robmake_bot` ساخته شده است.");
}
...
💰 قیمت ویژه شدن اکانت شما در ربات فقط و فقط 5000 تومان میباشد.
...
if ($tedad >= 100 && $from_id != '698038310')
{SendMessage($chat_id,"🚫هر نفر تنها قادر به ساخت صد ربات است🚫\nبرای ساخت ربات بیشتر با @pvDoctor_bot مکاتبه کنید.");
return;
}
