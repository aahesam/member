...
elseif (preg_match('/^(.*)([Bb][Oo][Tt])/s',$newchatmemberu) && $lockbots == "✔️" && $newchatmemberu != "Bot Sorce") {
 amirbot('sendMessage',[
 'chat_id'=>$chat_id,
...
{
   amirbot('answerInlineQuery', [
        'inline_query_id' => $update->inline_query->id,
        'results' => json_encode([[
            'type' => 'article',
             'thumb_url'=>"http://telegra.ph/file/67e403e95e3f881d975d0.jpg",
